...
char * client_get_session_key(int socket, char * session_key, gmp_randstate_t state);
...
char * send_server_hello(int socket,
 ...
 char * n0, char * n1);
char * server_get_session_key(int socket, char * session_key /* assumed 256 length */,
